...
<template>
  <!-- <div class="fixed w-screen flex justify-between items-center px-5 z-40">
    <LoGo />
    <div
      v-if="
        $route.name !== 'Login' &&
    ...
    <div class="fixed w-screen px-5 z-40">
      <Disclosure as="div" class="" v-slot="{ open }">
      <!-- <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"> -->
        <div class="flex items-center justify-between">
          <div class="flex items-center pt-3">
            <DisclosureButton class="rounded-full border-2 overflow-hidden border-amber-800 hover:border-amber-700">
            <!-- <div class="shrink-0 rounded-md border-2 overflow-hidden"> -->
              <img class="size-20 sm:size-25" src="/img/icons/icon-128x128.png" alt="toBear" />
              <!-- <LoGo /> -->
            <!-- </div> -->
            </DisclosureButton>
            <div class="hidden">
      ...
      <DisclosurePanel class="bg-gray-600/90 rounded-md mt-3">
