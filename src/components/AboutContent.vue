  ...
  <div class="mx-auto max-w-3xl text-base/7 text-tb-text-sec">
    ...
    <div class="mt-10 max-w-2xl space-y-6">
      ...
      <p>
        ...
        uno swipe per completare, uno per eliminare, un tocco lungo per riordinare. Clear è rimasta
        ferma nel tempo: solo iOS, mai aggiornata. toBear vuole essere il suo erede
