<template>
  <header>
    ...
    >
      ...
      <div class="flex lg:hidden">
        <button
          ...
          @click="mobileMenuOpenHeader = true"
        >
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        <div v-if="false">
          ...
          <RouterLink :to="navigationRoutes.home" class="text-sm/6 font-semibold text-gray-900"
            >Features</RouterLink
          >
          <RouterLink :to="navigationRoutes.home" class="text-sm/6 font-semibold text-gray-900"
    ...
    <Dialog class="lg:hidden" @close="mobileMenuOpenHeader = false" :open="mobileMenuOpenHeader">
      ...
      >
        <div class="flex items-center justify-between">
          <RouterLink
            ...
            @click="mobileMenuOpenHeader = false"
            class="-m-1.5 p-1.5"
          >
            <span class="sr-only">Your Company</span>
            <slot name="logo">
...
const mobileMenuOpenHeader = ref(false)
</script>
