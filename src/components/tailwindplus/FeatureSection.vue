  ...
  <div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:text-center">
        ...
        >
          <slot name="title">Everything you need to deploy your app</slot>
        </p>
        <p class="mt-6 text-lg/8 text-gray-600">
          <slot name="content"
            >Quis tellus eget adipiscing convallis sit sit eget aliquet quis. Suspendisse eget
            egestas a elementum pulvinar et feugiat blandit at. In mi viverra elit nunc.</slot
          >
        </p>
      </div>
          ...
          <div v-for="feature in features" :key="feature.name" class="relative pl-16">
            <dt class="text-base/7 font-semibold text-gray-900">
              ...
              >
                ...
                <HeroIcon :name="feature.icon" class="size-6 text-white" aria-hidden="true" />
              </div>
              {{ feature.name }}
            </dt>
